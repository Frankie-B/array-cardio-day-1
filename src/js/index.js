...
// const de = links
//   .map(link => link.textContent) // returns only the text contained within a link tag
//   .filter(streetName => streetName.includes('de')); // returns only streets with 'de' in the name
